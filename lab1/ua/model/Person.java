...
public class Person {
    ...
    public String getFullName() {
        return PersonUtils.formatFullName(firstName, lastName);
    }
    ...
    public void setFirstName(String firstName) {
        if (PersonUtils.isValidName(firstName)) {
            this.firstName = PersonUtils.capitalize(firstName);
        }
    }
    ...
    public void setLastName(String lastName) {
        if (PersonUtils.isValidName(lastName)) {
            this.lastName = PersonUtils.capitalize(lastName);
        }
    }
    ...
    public void setEmail(String email) {
        if (email != null) {
            String f = PersonUtils.formatEmail(email);
            if (PersonUtils.isValidEmail(f)) {
                this.email = f;
            }
        }
    }
